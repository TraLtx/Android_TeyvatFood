...
public class FragmentHisSuccess extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_his_success,container,false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tvTotal = view.findViewById(R.id.success_total);
        orderList = view.findViewById(R.id.success_list);
    ...
    private void getOrderListAPI() {
        ...
        ApiService.apiService.getOrderWithStatus(account.getId(), "Success").enqueue(new Callback<List<Order>>() {
            @Override
