...
public class FragmentHisShipping extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_his_shipping,container,false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tvTotal = view.findViewById(R.id.shipping_total);
        orderList = view.findViewById(R.id.shipping_list);
    ...
    private void getOrderListAPI() {
        ...
        ApiService.apiService.getOrderWithStatus(account.getId(), "Shipping").enqueue(new Callback<List<Order>>() {
            @Override
