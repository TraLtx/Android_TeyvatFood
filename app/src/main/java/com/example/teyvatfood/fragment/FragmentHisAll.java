...
public class FragmentHisAll extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_his_all,container,false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tvTotal = view.findViewById(R.id.all_total);
        orderList = view.findViewById(R.id.all_list);
    ...
    private void getOrderListAPI() {
        ...
        ApiService.apiService.getAllOrder(account.getId()).enqueue(new Callback<List<Order>>() {
            @Override
